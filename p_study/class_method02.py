...
# dir & __dict__ 확인
print(dir(car1))                                # 사용할 수 있는 내장함수를 전부 보여줌
print(dir(car2))

print()
print()

print(car1.__dict__)                            # 딕셔너리값 확인
print(car2.__dict__)


# Doctring

print(Car.__doc__)                              # 코멘트가 있다면 값을 확인할 수 있음.
print()
...
print(id(car1.__class__),id(car2.__class__),id(car3.__class__))             # 같은 class를 사용하기때매 id 값이 같음
